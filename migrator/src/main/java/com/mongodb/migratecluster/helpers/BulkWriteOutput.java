...
public class BulkWriteOutput {
    ...
    public BulkWriteOutput(int deletedCount, int modifiedCount, int insertedCount, int duplicateKeyExceptionCount, List<WriteModel<Document>> failedOps) {
    ...
    public int getSuccessfulWritesCount() {
        return deletedCount + modifiedCount + insertedCount + duplicateKeyExceptionCount;
    }
